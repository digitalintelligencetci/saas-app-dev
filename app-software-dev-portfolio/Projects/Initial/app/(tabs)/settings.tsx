...
import { Settings, Wifi, Thermometer, Shield, MapPin, Bell, Download, Info, CircleHelp as HelpCircle } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.settingsList}>
        ...
        <SettingItem
          ...
          title="About"
          subtitle="Version info and system diagnostics"
          onPress={() => showAlert('About', 'RF-Thermal Scanner v1.0.0\nBuild: 2025.01.20\nLicense: Emergency Services\n\nSystem Status: Operational')}
        />

        <View style={styles.versionInfo}>
          <Text style={styles.versionText}>RF-Thermal Scanner v1.0.0</Text>
          <Text style={styles.versionSubtext}>First Responder Edition</Text>
